-- Create a copy of the Default Lead Response template for Jesse to edit
INSERT INTO public.email_templates (
  ...
  'Default Lead Response - Jesse''s Copy',
  'Your Charter Quote - {{route}}',
  '<div style="font-family: -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, ''Helvetica Neue'', Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
