...
serve(async (req) => {
  ...
  try {
    ...
    const hardcodedAirports = [
        ...
        { code: 'KRYY', name: 'Cobb County Airport-McCollum Field', city: 'Atlanta', state: 'GA', country: 'US', type: 'General Aviation', runwayLength: 6305, source: 'Fallback Database' },
        { code: 'PDK', name: 'DeKalb-Peachtree Airport', city: 'Atlanta', state: 'GA', country: 'US', type: 'General Aviation', runwayLength: 6001, source: 'Fallback Database' },
        { code: 'KPDK', name: 'DeKalb-Peachtree Airport', city: 'Atlanta', state: 'GA', country: 'US', type: 'General Aviation', runwayLength: 6001, source: 'Fallback Database' },
        { code: 'VNY', name: 'Van Nuys Airport', city: 'Los Angeles', state: 'CA', country: 'US', type: 'General Aviation', runwayLength: 8001, source: 'Fallback Database' },
        { code: 'KVNY', name: 'Van Nuys Airport', city: 'Los Angeles', state: 'CA', country: 'US', type: 'General Aviation', runwayLength: 8001, source: 'Fallback Database' },
        { code: 'HPN', name: 'Westchester County Airport', city: 'White Plains', state: 'NY', country: 'US', type: 'General Aviation', runwayLength: 6549, source: 'Fallback Database' },
        { code: 'KHPN', name: 'Westchester County Airport', city: 'White Plains', state: 'NY', country: 'US', type: 'General Aviation', runwayLength: 6549, source: 'Fallback Database' },
