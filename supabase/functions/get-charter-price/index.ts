...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Charter price request:', JSON.stringify(requestBody, null, 2));

    // Call Aviapages API
    const aviapagesUrl = 'https://dir.aviapages.com/api/charter_prices/';
    ...
    console.error('Error in get-charter-price:', error);
    return new Response(JSON.stringify({
      success: false,
