...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Charter search request:', JSON.stringify(requestBody, null, 2));

    // Call Aviapages charter search API
    const aviapagesUrl = 'https://dir.aviapages.com/api/charter_searches/';
    console.log('Calling Aviapages charter search API:', aviapagesUrl);
    ...
    console.error('Error in search-charter-operators:', error);
    return new Response(JSON.stringify({
      success: false,
